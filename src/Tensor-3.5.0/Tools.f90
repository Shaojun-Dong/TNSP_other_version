...
contains
	 subroutine set_error_backtrace()
		...
		call writemess(' Add the code " -g -static -ffpe-trap=invalid " when compiling your files ')
		call writemess('  example: mpif90 -g -static -ffpe-trap=invalid test.f90 -o test')
		return
	end subroutine
