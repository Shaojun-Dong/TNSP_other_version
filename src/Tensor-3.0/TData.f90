...
!**************************************************************************************************************	
	...
	subroutine SVD_TData_routine(indata,U,S,V,m,n,min_MN,cut,info)
		...
		complex*16,allocatable :: zwork(:),zdata(:),uzdata(:,:),vzdata(:,:)
		complex*8,allocatable :: cwork(:),cdata(:),ucdata(:,:),vcdata(:,:)
		real*8,allocatable :: dwork(:),ddata(:),uddata(:,:),vddata(:,:),sdata8(:)
		real*4,allocatable :: swork(:),sdata(:),usdata(:,:),vsdata(:,:),sdata4(:)
		integer m,n,lw,rwdim,i,j
		integer,allocatable :: iw(:)
		real*8,allocatable :: drw(:)
		real*4,allocatable :: srw(:)
