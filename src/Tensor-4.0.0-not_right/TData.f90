...
module TData_module
	...
	public::modify_Some_TData_class1
	...
	public::modify_Some_TData_class2
	...
	public::modify_Some_TData_class3
	...
	public::modify_Some_TData_class4
	...
	public::TData_memory_report,TData_memory_length,dellocate_TData_memory,select_data_type_char
contains
...
!*******************  ifDynamic   *********
	...
	subroutine cleanDimension(Dimen)
		class(TData),intent(inout)::	Dimen
		call Dimen%Dimension%deallocate()
		if(allocated(Dimen%iData))deallocate(Dimen%iData)
		if(allocated(Dimen%sData))deallocate(Dimen%sData)
		if(allocated(Dimen%dData))deallocate(Dimen%dData)
		if(allocated(Dimen%cData))deallocate(Dimen%cData)
		if(allocated(Dimen%zData))deallocate(Dimen%zData)
		if(allocated(Dimen%lData))deallocate(Dimen%lData)
		if(allocated(Dimen%aData))deallocate(Dimen%aData)
...
!************************************************************************
	...
	subroutine ipointer2_(T,p)
		...
		d=T%dim()
		call ipointerToDataSubroutine2(p,T%idata,[1,d(1)],[1,d(2)],d(1),d(2))
		return
	end subroutine
	...
	subroutine spointer2_(T,p)
		...
		d=T%dim()
		call spointerToDataSubroutine2(p,T%sdata,[1,d(1)],[1,d(2)],d(1),d(2))
		return
	end subroutine
	...
	subroutine dpointer2_(T,p)
		...
		d=T%dim()
		call dpointerToDataSubroutine2(p,T%ddata,[1,d(1)],[1,d(2)],d(1),d(2))
		return
	end subroutine
	...
	subroutine cpointer2_(T,p)
		...
		d=T%dim()
		call cpointerToDataSubroutine2(p,T%cdata,[1,d(1)],[1,d(2)],d(1),d(2))
		return
	end subroutine
	...
	subroutine zpointer2_(T,p)
		...
		d=T%dim()
		call zpointerToDataSubroutine2(p,T%zdata,[1,d(1)],[1,d(2)],d(1),d(2))
		return
	end subroutine
	...
	subroutine lpointer2_(T,p)
		...
		d=T%dim()
		call lpointerToDataSubroutine2(p,T%ldata,[1,d(1)],[1,d(2)],d(1),d(2))
		return
	end subroutine
	...
	subroutine apointer2_(T,p)
		...
		d=T%dim()
		call apointerToDataSubroutine2(p,T%adata,[1,d(1)],[1,d(2)],d(1),d(2))
		return
	end subroutine
	...
	subroutine ipointer3_(T,p)
		...
		d=T%dim()
		call ipointerToDataSubroutine3(p,T%idata,[1,d(1)],[1,d(2)],[1,d(3)],d(1),d(2),d(3))
		return
	end subroutine
	...
	subroutine spointer3_(T,p)
		...
		d=T%dim()
		call spointerToDataSubroutine3(p,T%sdata,[1,d(1)],[1,d(2)],[1,d(3)],d(1),d(2),d(3))
		return
	end subroutine
	...
	subroutine dpointer3_(T,p)
		...
		d=T%dim()
		call dpointerToDataSubroutine3(p,T%ddata,[1,d(1)],[1,d(2)],[1,d(3)],d(1),d(2),d(3))
		return
	end subroutine
	...
	subroutine cpointer3_(T,p)
		...
		d=T%dim()
		call cpointerToDataSubroutine3(p,T%cdata,[1,d(1)],[1,d(2)],[1,d(3)],d(1),d(2),d(3))
		return
	end subroutine
	...
	subroutine zpointer3_(T,p)
		...
		d=T%dim()
		call zpointerToDataSubroutine3(p,T%zdata,[1,d(1)],[1,d(2)],[1,d(3)],d(1),d(2),d(3))
		return
	end subroutine
	...
	subroutine lpointer3_(T,p)
		...
		d=T%dim()
		call lpointerToDataSubroutine3(p,T%ldata,[1,d(1)],[1,d(2)],[1,d(3)],d(1),d(2),d(3))
		return
	end subroutine
	...
	subroutine apointer3_(T,p)
		...
		d=T%dim()
		call apointerToDataSubroutine3(p,T%adata,[1,d(1)],[1,d(2)],[1,d(3)],d(1),d(2),d(3))
		return
	end subroutine
	...
	subroutine ipointer4_(T,p)
		...
		d=T%dim()
		call ipointerToDataSubroutine4(p,T%idata,[1,d(1)],[1,d(2)],[1,d(3)],[1,d(4)],d(1),d(2),d(3),d(4))
		return
	end subroutine
	...
	subroutine spointer4_(T,p)
		...
		d=T%dim()
		call spointerToDataSubroutine4(p,T%sdata,[1,d(1)],[1,d(2)],[1,d(3)],[1,d(4)],d(1),d(2),d(3),d(4))
		return
	end subroutine
	...
	subroutine dpointer4_(T,p)
		...
		d=T%dim()
		call dpointerToDataSubroutine4(p,T%ddata,[1,d(1)],[1,d(2)],[1,d(3)],[1,d(4)],d(1),d(2),d(3),d(4))
		return
	end subroutine
	...
	subroutine cpointer4_(T,p)
		...
		d=T%dim()
		call cpointerToDataSubroutine4(p,T%cdata,[1,d(1)],[1,d(2)],[1,d(3)],[1,d(4)],d(1),d(2),d(3),d(4))
		return
	end subroutine
	...
	subroutine zpointer4_(T,p)
		...
		d=T%dim()
		call zpointerToDataSubroutine4(p,T%zdata,[1,d(1)],[1,d(2)],[1,d(3)],[1,d(4)],d(1),d(2),d(3),d(4))
		return
	end subroutine
	...
	subroutine lpointer4_(T,p)
		...
		d=T%dim()
		call lpointerToDataSubroutine4(p,T%ldata,[1,d(1)],[1,d(2)],[1,d(3)],[1,d(4)],d(1),d(2),d(3),d(4))
		return
	end subroutine
	...
	subroutine apointer4_(T,p)
		...
		d=T%dim()
		call apointerToDataSubroutine4(p,T%adata,[1,d(1)],[1,d(2)],[1,d(3)],[1,d(4)],d(1),d(2),d(3),d(4))
		return
	end subroutine
